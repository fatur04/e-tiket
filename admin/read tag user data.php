...
<?php
//kirim WA
// $nama = $data['nama_absen'];

// $kirim = [
//     'phone' => $data['wa_absen'], // Receivers phone
//     'body' => "Selamat $nama Sudah Absen.", // Message
// ];
...
?> 
		...
		<div>
			...
			if (isset($_GET["id"])) {
				...
				$koneksi->query("UPDATE absen SET status_absen = 'Sudah Absen' WHERE rfid='$id' ");

				$tanggal = date("Y-m-d");
				
				$koneksi->query("UPDATE absen SET tanggal_sekarang='$tanggal',
					absen_masuk = NOW() 
					WHERE rfid='$id' ");
